...
class AppThemePalette {
  ...
  static const sweetCream = AppThemePalette(
    ...
    textOnPrimary: Color(0xFF3D312A),
    background: Color(0xFFFAF7F2),
    surface: Color(0xFFFFFFFF),
    surfaceElevated: Color(0xFFF0EAE1),
    textPrimary: Color(0xFF3D312A),
    textSecondary: Color(0xFF7C6E65),
    textMuted: Color(0xFFA89F98),
    borderSubtle: Color(0x337C6E65),
    borderCard: Color(0x33DB2777),
    searchBarBackground: Color(0xFFF0EAE1),
    searchBarIcon: Color(0xFFDB2777),
    searchBarPlaceholder: Color(0xFF7C6E65),
    searchBarText: Color(0xFF3D312A),
